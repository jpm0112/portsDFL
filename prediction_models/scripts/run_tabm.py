...
def main() -> None:
    ...
    # A nested helper that builds a fresh TabM from hyperparameters. `**hp` collects
...
# This block runs only when the file is executed directly (e.g. `python run_tabm.py`),
